...
public class Encoder {
	...
	public MultimediaInfo getInfo(File source) throws InputFormatException,
			EncoderException {
		return infoGetter(source.getAbsolutePath());
	}
	 ...
	 *             If a problem occurs calling the underlying ffmpeg executable.
	 */
	public MultimediaInfo getInfo(URL source) throws InputFormatException,
			EncoderException {
		return infoGetter(source.toString());
	}
        
        private MultimediaInfo infoGetter(String source) throws InputFormatException,
			EncoderException {
		FFMPEGExecutor ffmpeg = locator.createExecutor();
	...
	public void encode(File source, File target, EncodingAttributes attributes,
		...
		encoderMethod(source.getAbsolutePath(),target,attributes,listener);
	}
	...
	public void encode(URL source, File target, EncodingAttributes attributes,
			EncoderProgressListener listener) throws IllegalArgumentException,
			InputFormatException, EncoderException {
		encoderMethod(source.toString(),target,attributes,listener);
	}

        private void encoderMethod(String source,File target, EncodingAttributes attributes, EncoderProgressListener listener) throws IllegalArgumentException, InputFormatException, EncoderException {
